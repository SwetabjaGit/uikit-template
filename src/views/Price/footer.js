      ...
      <div class="uk-container uk-section">
        <div class="uk-grid uk-child-width-1-3@l" data-uk-grid>
          ...
          <div>
            ...
            <h4>Social Media</h4>
            <a href="/" class="uk-icon-button  uk-margin-small-right" data-uk-icon="facebook"><span></span></a>
            <a href="/" class="uk-icon-button  uk-margin-small-right" data-uk-icon="twitter"><span></span></a>
            <a href="/" class="uk-icon-button" data-uk-icon="instagram"><span></span></a>
          </div>
        </div>
      </div>
